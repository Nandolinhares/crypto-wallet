  ...
  return (
    <FormControl component="fieldset">
      ...
      <RadioGroup aria-label="gender" name="gender1" value={cryptoSelected} onChange={handleChange} row>
        <FormControlLabel id="bitcoin-brita" className={classes.formControlLabel} value="bitcoin" control={<GreenRadio />} label="Bitcoin para Brita" />
        <FormControlLabel id="brita-bitcoin" className={classes.formControlLabel} value="brita" control={<GreenRadio />} label="Brita para Bitcoin" />
      </RadioGroup>
    </FormControl>
  )
}
